...
public class Variaveis {
    public static void main(String[] args) {
         ...
         * long numLong = 2147483647; // -9 223 372 036 854 770 000, o valor máximo é 9
         * 223 372 036 854 770 000 (64 bits)
         * 
         * float numFloat = 10.000f; // -14924E -37 a 3.40282347E + 38 (32 bits)
         * double numDouble = 100000000000000.000; // -4,94E-307 a
         * 1.79769313486231570E+308 (64 bits)
         * 
